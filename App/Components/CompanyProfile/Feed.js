...
class Feed extends Component {
  static navigationOptions = {
    ...
    render() {
        ...
        <ETIcon name="dots-three-vertical" size={25} color={'#32cd32'} onPress={() => this.props.navigation.navigate('EditCompany')}  />
        </TouchableOpacity>
        </View>

        <View style={{  alignItems: 'center', justifyContent: 'center' }}>
                  <View style={{ backgroundColor: 'white', height: responsiveHeight(30), width: responsiveWidth(100) }}>
                    <Image source={require('../../Assets/watch.jpg')} style={{ width: '100%', height: '100%', borderRadius: 0 }} />
                </View>

                <View style={{ backgroundColor: 'white', height: responsiveHeight(32), width: responsiveWidth(100), borderRadius: 20, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.5, shadowRadius: 2, elevation: 1, }}>

                    <View style={{ alignSelf: 'center',top:10,backgroundColor: 'white' ,justifyContent: 'flex-start', width: '90%', height: '20%', }}>
                        <Text style={{ left:5,fontSize: responsiveFontSize(3), color: '#32cd32',fontWeight:'bold'}}>
                           ABC Company
                        </Text>
                    </View>

                    <View style={{ paddingHorizontal:5,alignSelf: 'center', top:0,backgroundColor: 'white', justifyContent: 'space-around', alignItems: 'flex-start', width: '90%', height: '35%', }}>
                        {/* <Text style={{letterSpacing:1, left:2,fontSize: responsiveFontSize(2), color: '#7e7474' }}>
                            Company Info
                        </Text> */}
                        <Text style={{ left:1,fontSize: responsiveFontSize(1.8),fontWeight:'bold', color: '#7e7474' }}>
                           Address: 
                           <Text style={{letterSpacing:1,fontSize:responsiveFontSize(1.6),fontWeight:'800'}}>
                             Plot 14 Street 12
                           </Text>
                        </Text>
                        <Text style={{ left:1,fontSize: responsiveFontSize(1.8), fontWeight:'bold',color: '#7e7474' }}>
                    ...
                    <View style={{ alignSelf: 'center', top:5,backgroundColor: 'white', width: '90%', height: '10%',flexDirection:'row' }}>
                        <View style={{paddingHorizontal:7,width:'80%',height:'100%',flexDirection:'row',justifyContent:'space-between'}}>
                        <Text style={{ left:1,fontSize: responsiveFontSize(1.8), color: '#7e7474' }}>
                           9:00 AM - 5:00 PM
                        </Text>

                        <Text style={{letterSpacing:1,fontSize:responsiveFontSize(1.6),fontWeight:'bold',}}>Sat-Sun off</Text>
                            </View>

                            <TouchableOpacity style={{top:-18, backgroundColor:'white',width:'20%',height:'100%',flexDirection:'column',justifyContent:'flex-start',alignItems:'center',position:'absolute',left:responsiveWidth(75)}}>
                            <View style={{flexDirection:'column',height:'100%',width:'50%',alignItems:'center',justifyContent:'space-evenly',left:0}}>
                            <Text style={{ fontSize: responsiveFontSize(2), color: '#40d240',fontWeight:'bold',marginBottom:10 }}>
                           45
                        </Text>
                        <TouchableOpacity>
                    ...
                    <View style={{ marginTop:2,padding:0,paddingVertical:8,alignSelf: 'center',top:0, backgroundColor: 'white', width: '90%', height: '34%' }}>
                   <Text numberOfLines={3} style={{flex:1,flexGrow:1, fontSize: responsiveFontSize(1.8), color: '#7e7474' }}>
    ...
    {/* #ebeeeb */}
    <View style={{ borderRadius:10,width: '96%', backgroundColor: "", height: '12%',
     justifyContent: 'space-between',elevation:1,alignSelf:'center' }}>
        <TextInput  multiline={true} numberOfLines={6} style={{textAlignVertical: "top", 
        fontSize: responsiveFontSize(2), height: '100%', width: '100%', paddingHorizontal: 10 }} placeholder={'Post Something'}  />
...
<Text style={{ marginLeft:5,fontSize: responsiveFontSize(1.8), color: 'white', }}>
    Post
        ...
        <View key={index}  style={{  shadowColor: '#000',shadowOffset: { width: 0, height: 2 },shadowOpacity: 0.5,shadowRadius: 2, elevation: 2, backgroundColor: '#eee', width: '100%', height: height, borderRadius: 25, paddingVertical: 20, paddingHorizontal: 10, backgroundColor: 'white',marginBottom:5 }}>
          ...
          <View style={{ height: '20%',backgroundColor:'white' , flexDirection: 'row', padding: 1, marginHorizontal: 20,marginTop:5,alignItems:'center' }}>
            <TextInput style={{ fontSize:responsiveFontSize(1.8),paddingLeft:20,padding:5, height:'100%',backgroundColor: '#dee3e1', width: '80%', borderRadius: 50, }} placeholder='Type something'placeholderStyle={{ marginLeft:20,fontSize:responsiveFontSize(1.8)  }}>
...
/> 
        ...
        <Image source={require('../../Assets/cow.png')} style={{width:responsiveWidth(100), height:responsiveHeight(73)}} />
        </View>
      </ScrollableTabView>
