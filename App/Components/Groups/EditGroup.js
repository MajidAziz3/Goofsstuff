            ...
            <View style={styles.container}>
                ...
                <ScrollView style={styles.container1}>
                    <View style={styles.bodyContainer}>
                        ...
                        <View style={{ padding: 5, marginBottom: 5, backgroundColor: 'white', width: '100%', height: responsiveHeight(40), shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.2, shadowRadius: 1.41, elevation: 3, borderRadius: 5 ,justifyContent:'space-evenly'}}>
                            ...
                            <View style={{ backgroundColor: 'white', height: '35%', flexDirection: 'row', justifyContent: 'space-between', }}>

                                <View style={{ paddingHorizontal: 5, width: '40%', height: '100%', justifyContent: 'flex-start', top: 20 }}>
                                    <Text style={{ fontSize: responsiveFontSize(1.8), color: '#000000', }}>
                                        Description
</Text>
                                </View>

                                <TextInput placeholder='Some Sample text ' multiline={true} style={{ textAlignVertical: "top",fontSize: 12, marginTop: 3, padding: 5, justifyContent: 'center', backgroundColor: 'white', width: '60%', height: '90%', shadowColor: 'black', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.2, shadowRadius: 1.41, elevation: 5, borderRadius: 10 }}>
                            ...
                            <View style={{ backgroundColor: 'white', height: '20%', flexDirection: 'row', padding: 0 }}>
                                <View style={{ width: '40%', height: '100%', justifyContent: 'center' }}>
                                    <Text style={{ fontSize: responsiveFontSize(2), color: '#7e7a7a', alignSelf: 'flex-start' }}>
                                        Category*
            </Text>
                                </View>
                                <View style={{ marginTop: 5, justifyContent: 'center', width: '60%', height: '70%', shadowColor: 'black', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.2, shadowRadius: 1.41, elevation: 1, backgroundColor: 'white', borderRadius: 5 }}>
                                    <Picker
                        ...
                        <View style={{ backgroundColor: 'white', height: responsiveHeight(45), marginTop: 5, shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.2, shadowRadius: 1.41, elevation: 5, borderRadius: 10 }}>
                            <View style={{ backgroundColor: 'white', height: '20%', justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
                                <Text style={{ fontSize: responsiveFontSize(2.6), color: '#000', alignSelf: 'center' }}>
                                   People
</Text>
                            <TouchableOpacity onPress={() => this.props.navigation.navigate('AddUserlist')} style={{ left: responsiveWidth(25) }}>
                    ...
                    <View style={{ marginTop: 0, backgroundColor: "white", width: '100%', height: responsiveHeight(7), justifyContent: 'center', alignItems: 'center', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.2, shadowRadius: 1.41, elevation: 2, borderRadius: 10 }}>
