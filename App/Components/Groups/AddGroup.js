        ...
        return (
            <View style={styles.container}>
                ...
                <ScrollView style={styles.container1}>
                    ...
                    <View style={{ marginTop: 0, backgroundColor: "white", width: '100%', height: responsiveHeight(10), justifyContent: 'center', alignItems: 'center', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.2, shadowRadius: 1.41, elevation: 2, borderRadius: 10 }}>
